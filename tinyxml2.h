...
class MemPoolT : public MemPool {
 public:
  ...
  virtual int ItemSize() const override { return ITEM_SIZE; }
...
class TINYXML2_LIB XMLDeclaration : public XMLNode {
 ...
 protected:
  ...
  virtual ~XMLDeclaration() override;
